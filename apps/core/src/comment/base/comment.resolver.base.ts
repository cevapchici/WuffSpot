...
export class CommentResolverBase {
  ...
  @graphql.ResolveField(() => DogPark, {
    nullable: true,
    name: "dogPark",
  })
  async getDogPark(@graphql.Parent() parent: Comment): Promise<DogPark | null> {
    const result = await this.service.getDogPark(parent.id);
